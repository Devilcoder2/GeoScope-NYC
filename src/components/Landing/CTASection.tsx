    ...
    <section className="relative py-24 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <div id="Explore" className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-3xl p-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              Ready to Explore?
            </h2>
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Dive into comprehensive population data visualization and discover
              insights through our advanced mapping platform.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                whileHover={{
                  scale: 1.05,
                  boxShadow: "0 20px 40px -20px rgba(0, 212, 255, 0.5)",
                }}
                whileTap={{ scale: 0.95 }}
              ...
              <motion.button
                ...
                onClick={() =>
                  window.open(
                    "https://github.com/Devilcoder2/GeoScope-NYC",
                    "_blank"
                  )
                }
